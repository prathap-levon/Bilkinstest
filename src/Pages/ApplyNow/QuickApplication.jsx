...
export const QuickApplication = ({ open,handleCancel }) => {
  const { id } = useParams();
  ...
  const handleSubmit = async (event) => {
    try {
      ...
      // if(!loggedInUserInfo?.token){
      //   showErrorAlert("Please login to continue...")
      //   return;
      // }
                  ...
                  <form className="row g-3">
                    ...
                    <div className="col-md-12">
                      ...
                      <p style={{ fontSize: "12px", color: "#555" }}>
                        Accepted file types include Word document (.doc, .docx),
                        a PDF created from a text file (not scanned in as an
                        image), or a plain .txt, .rtf, .html, or .odt file.
                      </p>
                    </div>

    ...
    return (
        <>
            ...
            <Form onSubmit={handleFormSubmit}>
                <h4 style={{ textAlign: 'center', fontWeight: 'bold', marginBottom: '20px' }}>{getHeading()}</h4>
                {step === 1 && (
                            ...
                            <>
                                ...
                                <div className="col-md-6">
                                    ...
                                    <Select
                                        ...
                                        value={item?.schoolType?.value ? item?.schoolType : item?.schoolType === null ? null : { value: item?.schoolType, label: item?.schoolType }}
                                ...
                                <div className="col-md-6">
                                    ...
                                    <Select
                                        ...
                                        options={stateLicenceOptions}
                                        value={item?.schoolState?.value ? item?.schoolState : item?.schoolState === null ? null : { value: item?.schoolState, label: item?.schoolState }}
                            ...
                            <>
                                <div className="col-md-4">
                                    ...
                                    <Select
                                        placeholder='Select State'
                                        options={stateLicenceOptions}
                                        value={item?.state?.value ? item?.state : item?.state == null ? null : { value: item?.state, label: item?.state }}

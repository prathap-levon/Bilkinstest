...
export const ServicepageProcess = ({ data }) => {
        ...
        <div>
            <Container fluid className="servicepage-Process-container">
                <Row>
                    ...
                    <Col
                        md={4}
                        className="service-page-right mt-4 "
                    ...
                    >
                        ...
                        <div className="service-job-details">
                            {/* <div className="d-flex flex-wrap gap-4 ">
                                {cardsData.map((card, index) => (
                                    <ServiceCard key={index} title={card.title} date={card.date} icon={card.icon} />
                                ))}
                            </div> */}
                            <div className="service-job-location">
                                <div
                                    style={{
                                        borderRight: "2px solid #e0e7fa",
                                        paddingRight: "3px",
                                    }}
                                >
                                    <h3>Salary(USD)</h3>
                        ...
                        <div className="servicePage-socialmedia">
                            ...
                            <button className="copylinks-button">
                                ...
                                >
                                    <path
                                        d="M8.81738 15.1804L15.1813 8.81641"
                                        stroke="#CE1B28"
                                        strokeWidth="2"
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                                    />
                                    <path
                                        d="M13.5909 16.7722L10.9392 19.4238C10.0953 20.2675 8.95077 20.7414 7.75743 20.7413C6.56409 20.7412 5.41965 20.2671 4.57583 19.4233C3.73201 18.5794 3.25791 17.435 3.25781 16.2417C3.25771 15.0483 3.73161 13.9038 4.57529 13.0598L7.22694 10.4082"
                                        stroke="#CE1B28"
                                        strokeWidth="2"
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                                    />
                                    <path
                                        d="M16.7731 13.5909L19.4248 10.9392C20.2685 10.0953 20.7424 8.95077 20.7423 7.75743C20.7422 6.56409 20.2681 5.41965 19.4243 4.57583C18.5804 3.73201 17.436 3.25791 16.2427 3.25781C15.0493 3.25771 13.9048 3.73161 13.0608 4.57529L10.4092 7.22694"
                                        stroke="#CE1B28"
                                        strokeWidth="2"
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
